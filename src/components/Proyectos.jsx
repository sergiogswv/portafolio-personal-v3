...
const Proyectos = () => {
  return (
    <div>
      <h1 className="text-center text-white uppercase text-lg">
        Proyectos en curso:
      </h1>
      <p className=" grid bgSecondary w-3/5 h-1 mx-auto"></p>

      <section className="flex justify-around flex-wrap mx-auto mb-5">
        {proyectos.map((proyecto) => (
          <article key={proyecto.id} className="">
            <div className="mx-auto">
              ...
              />
              <p className="text-white text-center w-11/12">
                {proyecto.nombre}{" "}
